...
export interface Env {
  hooks?: { beforeGenerationLeaseClaim?: (env: Env, convId: string) => Promise<void>; beforeAiDispatchPreflight?: (env: Env, convId: string) => Promise<void>; beforeVisibleSend?: (env: Env, accountRef: string, convRef: string, content: string, opId: string) => Promise<{ id?: number | string }> };
  DB: D1Database;
