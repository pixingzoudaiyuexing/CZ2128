...
- Abandoned convergence accepts SENT only with a bounded provider message reference, including after a lost cleanup CAS. Malformed SENT blocks domain repair and DLQ resolution; durable AI text is not provider-delivery proof.
