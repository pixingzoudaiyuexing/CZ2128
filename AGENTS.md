...
Phases 1, 2, 3 and 3.5 are complete and merged. Phase 4A reliability architecture is frozen. Phase 4B-1 error-taxonomy and retry-contract implementation is complete; Phase 4B-2A COMPLETE; Phase 4B-2B COMPLETE / FROZEN; Phase 4B-2C-1 COMPLETE / FROZEN; Phase 4B-2C-2 COMPLETE / FROZEN; Phase 4B-2C-3 COMPLETE / FROZEN / MERGED. Phase 4B-2C overall is COMPLETE / FROZEN. Phase 4B-3 is COMPLETE / FROZEN / MERGED. Phase 4B-4A is COMPLETE / FROZEN / MERGED. Phase 4B-4B is ACCEPTED / COMPLETE / FROZEN / MERGED. Phase 4B-4 overall is COMPLETE / FROZEN / MERGED. Phase 4B-5 is ACCEPTED / COMPLETE / FROZEN / MERGED. Phase 4C is IN EXECUTION: the isolated staging foundation exists and separately bounded Crisp-02 basic-support, Crisp-03 AI/handoff, Crisp-04 lifecycle and Crisp-05 attachment/upload Staging evidence is recorded.

`ARCHITECTURE.md` and `DECISIONS.md` remain the approved V1 baseline. Phase 3 preserves the hardened webhook, Queue, outbound ambiguity and AI handoff contracts from Phases 1 and 2. The scoped Crisp-03/04/05 results do not close broader R2 proxy/cleanup, Queue/D1 concurrency, load, fault, Admin or Production requirements; consult `PREPRODUCTION-ACCEPTANCE.md` before treating any capability as real-environment accepted.
...
- Abandoned convergence treats SENT as delivery truth only with a bounded provider message reference; malformed SENT blocks domain repair and DLQ resolution.
